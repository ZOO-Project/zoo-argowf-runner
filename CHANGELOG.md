...
All notable changes to zoo-argowf-runner will be documented in this file.
...
### Added
- GitHub Issue and Pull Request templates to standardise contributions
- A placeholder test to satisfy CI until full unit tests are available
...
- `zoo-runner-common` as an official dependency for shared runner functionality
- `zoo-template-common` as a dependency for reusable template utilities
...
- `ZooArgoWorkflowsRunner` now inherits from `BaseRunner` (from `zoo-runner-common`) for common methods
...
See [GitHub Releases](https://github.com/ZOO-Project/zoo-argowf-runner/releases) for the complete version history.
